...
for line in e:
    ...
    a1 = (int(CHROM_SIZE * (degrees(atan2(y1, x1)) + 180) / 360) + (CHROM_SIZE / 2)) % CHROM_SIZE
    a2 = (int(CHROM_SIZE * (degrees(atan2(y2, x2)) + 180) / 360) + (CHROM_SIZE / 2)) % CHROM_SIZE

    print("%s %s %s %s %s %s score=%s" % (CHROM, a1, a1, CHROM, a2, a2, score))
